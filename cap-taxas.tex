...
\begin{proof}
  ...
  Caso não existe uma susequência onde $\gamma_y$ vá ao infinito,
  ...
  Como  $p_{\infty y}(t) \to 0$ quando $t \searrow 0$, concluíremos que:
  \begin{displaymath}
    \frac{p_{\infty y}}{t} \xrightarrow{t \searrow 0} 0.
  \end{displaymath}

  Mas esse resultado contradiz  Proposição \ref{prop:taxa-inf-x}.
\end{proof}
