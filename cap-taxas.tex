...
Nesse capítulo vamos nos concentrar em problemas ligados às
probabilidades de transição do processo K. Primeiramente vamos tratar
de problemas relacionados à continuidade das mesmas, para depois
calcular suas derivadas na origem. Isso nos permitirá calcular a
medida invariante do processo.

Por fim iremos exibir o gerador infinitesimal no caso homogêneo e
fecharemos o capítulo estudando a dimensão de Hausdorff do tempo em
...
com uma caracterização básica delas.
...
\begin{proof}
  ...
  infinito, e que o limite seguindo $v$ inteiro é um limitante
