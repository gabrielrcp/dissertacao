...
\begin{proof}
  ...
  grande, de forma que $\delta_n < t$ e $\delta_n <
  \lambda_n^y(t)$. Usando a Proposição \ref{prop:reinicia-infinito} e
  separando nos casos $\gamma_yT_0 < \delta_n$ e $\gamma_yT_0 \geq
  \delta_n$, teremos que:
  \begin{align}
